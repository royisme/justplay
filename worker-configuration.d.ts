/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cfe1a419c826a6a80e1ea8b05cb47d3b)
// Runtime types generated with workerd@1.20260107.1 2025-11-01 nodejs_compat
export {};
declare global {
	const GAME_STATE: KVNamespace;
	const OPENROUTER_MODEL: "openai/gpt-4o";
	const BETTER_AUTH_SECRET: string;
	const BETTER_AUTH_URL: string;
	const ADMIN_EMAIL: string;
	const CUSTOM_API_KEY: string;
	const CUSTOM_BASE_URL: string;
	const CUSTOM_MODEL: string;
	const NODE_NUM: string;
	const DB: D1Database;
}
